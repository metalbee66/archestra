...
export async function evaluateIfContextIsTrusted(
  ...
  // pre-mark the context as untrusted but continue evaluating tool result
  // policies so blocked/sanitized content is still replaced before being
  // sent to the model. Returning early here would let blocked tool results
  // through unmodified (see issue #4225).
